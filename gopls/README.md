...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/kent0106/gotools/gopls)](https://pkg.go.dev/github.com/kent0106/gotools/gopls)
...
```sh
GO111MODULE=on go get github.com/kent0106/gotools/gopls@latest
```
