...
import (
	...
	"github.com/kent0106/gotools/internal/lsp/command/commandmeta"
...
func rewriteAPI(_ []byte, api *source.APIJSON) ([]byte, error) {
	...
	fmt.Fprintf(buf, "// Code generated by \"github.com/kent0106/gotools/gopls/doc/generate\"; DO NOT EDIT.\n\npackage source\n\nvar GeneratedAPIJSON = %s\n", apiBytes)
