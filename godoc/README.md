...
executable lives at github.com/kent0106/gotools/cmd/godoc.
...
```
godoc -templates=$GOPATH/src/github.com/kent0106/gotools/godoc/static -http=:6060
```
...
2) Run `go generate github.com/kent0106/gotools/godoc/static` so `static/static.go` picks
up the change.

3) Run `go install github.com/kent0106/gotools/cmd/godoc` so the compiled `godoc` binary
picks up the change.
